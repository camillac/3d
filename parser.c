  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
    ...
    if ( strncmp(line, "circle", strlen(line)) == 0 ) {
      ...
      sscanf(line, "%lf %lf %lf %lf",
             xvals, yvals, zvals, r);
      add_circle( edges, xvals[0], yvals[0], zvals[0], r[0], step);
    }//end of circle
      ...
      *strchr(line, '\n') = 0;
      ...
      /*printf("%lf %lf %lf %lf",
        xvals[0], yvals[0], zvals[0], r[0]) */
      add_sphere(edges, xvals[0], yvals[0], zvals[0], r[0], 20);
    }//end sphere
      ...
      /*printf("%lf %lf %lf %lf %lf",
        xvals[0], yvals[0], zvals[0], r[0], r[1]) */
      add_torus(edges, xvals[0], yvals[0], zvals[0], r[0], r[1], 20);
    }//end torus
